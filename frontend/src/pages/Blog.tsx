...
const BlogPage: React.FC = () => {
    ...
    const PostCard = ({ post }: { post: BlogPost }) => (
        <motion.div
            ...
            onClick={() => setSelectedPost(post)}
            className="bg-white dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all cursor-pointer flex flex-col h-full group"
        >
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="p-10 md:p-16 prose dark:prose-invert prose-lg max-w-none">
                        {/* This would be a markdown renderer in production */}
